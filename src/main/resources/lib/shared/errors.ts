...
export const ERRORS = {
    ...
    REST_CONTENT_ID_REQUIRED: err(11, 'Content id is required.'),
    REST_FIELDS_REQUIRED: err(12, 'Fields are required.'),
    REST_REQUEST_PARAMS_MISSING: err(13, 'Request params are missing.'),
    REST_LANGUAGE_MISSING: err(14, 'Language is required.'),
    REST_CONTEXT_MISSING: err(15, 'Context is required.'),
