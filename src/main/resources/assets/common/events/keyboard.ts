export type ReactKeyboardHandler<T extends EventTarget = HTMLElement> = (
  event: React.KeyboardEvent<T>,
) => void;
export type ReactMouseHandler<T extends EventTarget = HTMLElement> = (
...
export type MouseKeyboardEvent<T extends HTMLElement = HTMLElement> =
  | React.MouseEvent<T>
